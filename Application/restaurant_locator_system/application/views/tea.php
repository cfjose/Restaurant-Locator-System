...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="http://localhost/restaurant_locator_system/res/images/main/tea_cuisine.jpg" alt="First slide">
            <h3>Welcome!</h3>
            <h5>Search for Tea Houses Nearby.</h5>
            <div id="search">
...
<div class="content">
    ...
    $queryCat = "SELECT id FROM category WHERE name = 'Tea'";
