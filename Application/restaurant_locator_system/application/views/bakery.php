...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="http://localhost/restaurant_locator_system/res/images/main/bakery_cuisine.jpg" alt="First slide">
            <h3>Welcome!</h3>
            <h5>Search for Bakery Shops Nearby.</h5>
            <div id="search">
...
<h2>Bakery Shops</h2><br/>

<div class="content">
    <?php
    $link = mysqli_connect("localhost", "root", "projDb_2016", "rls_db");

    $queryCat = "SELECT id FROM category WHERE name = 'Bakery'";
